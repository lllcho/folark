...
class Settings(BaseSettings):
    ...
    ALLOWED_EXTENSIONS: set[str] = (
        DOCUMENT_EXTENSIONS | EBOOK_EXTENSIONS | TEXT_EXTENSIONS |
        IMAGE_EXTENSIONS | AUDIO_EXTENSIONS | VIDEO_EXTENSIONS | ARCHIVE_EXTENSIONS
    )
...
EDITABLE_KEYS: set[str] = {
    "LOG_LEVEL", "MAX_UPLOAD_SIZE", "IMPORT_DIR_WHITELIST",
    "DOCUMENT_EXTENSIONS", "EBOOK_EXTENSIONS", "TEXT_EXTENSIONS",
...
def get_settings() -> Settings:
    ...
    object.__setattr__(s, "ALLOWED_EXTENSIONS", (
        s.DOCUMENT_EXTENSIONS | s.EBOOK_EXTENSIONS | s.TEXT_EXTENSIONS |
        s.IMAGE_EXTENSIONS | s.AUDIO_EXTENSIONS | s.VIDEO_EXTENSIONS | s.ARCHIVE_EXTENSIONS
    ))
    return s
