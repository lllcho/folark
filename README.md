...
folark 是一个**本地优先**的文档管理 Web 应用，支持多种文件格式的上传、格式转换、预览、搜索和标签管理。所有数据存储在你自己的机器上，无需依赖任何云服务。
...
| 文件列表/搜索功能 | txt转epub格式预览 | 暗黑模式 |
|:---:|:---:|:---:|
| ![首页](docs/images/pc5.jpeg) | ![登录页](docs/images/pc2.jpg) | ![文档预览](docs/images/pc1.jpeg) |

| 导入页面 | 设置页面 | 文件详情 |
|:---:|:---:|:---:|
| ![导入页面](docs/images/pc6.jpeg) | ![设置页面](docs/images/pc4.jpeg) | ![搜索](docs/images/pc3.jpeg) |

### 移动端

| 文档列表 | 设置 | 后台任务 | txt转epub预览 |
|:---:|:---:|:---:|:---:|
| ![移动端登录](docs/images/mobile2.jpeg) | ![移动端文档列表](docs/images/mobile3.jpeg) | ![移动端文档详情](docs/images/mobile4.jpeg) | ![移动端导入](docs/images/mobile4.jpeg) |
